...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        configuration.addAnnotatedClass(dk.lyngby.model.Guest.class);
        configuration.addAnnotatedClass(dk.lyngby.model.Event.class);
        configuration.addAnnotatedClass(dk.lyngby.model.Ticket.class);
    }
